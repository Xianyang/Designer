...
@property (strong,nonatomic) BeginUpdatingBlock5 beginUpdatingBlock;
...
- (void)viewDidLoad {
    ...
    __block FifthViewController *weakSelf = self;
    self.beginUpdatingBlock = ^(FifthViewController *viewController) {
...
- (void)startDownloadArticleData
{
    ...
    NSDictionary *dic = [self.data getArtilcleByGroupNumber:5 withLoadNumber:_loadMoreArticleCount];
