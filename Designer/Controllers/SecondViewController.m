...
@interface SecondViewController () <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
...
@property (strong,nonatomic) BeginUpdatingBlock2 beginUpdatingBlock;
...
- (void)viewDidLoad {
    ...
    self.beginUpdatingBlock = ^(SecondViewController *viewController) {
